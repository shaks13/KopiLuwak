...
#define configSLEEP_MODE           (sleepEM2)
...
#else
#define configTICK_RATE_HZ    ( 1000 ) /*1000 for 1ms 10000 for 0.1ms*/
#endif
...
#define configTOTAL_HEAP_SIZE                     (( size_t )((4+1)*1024))  /* 4 tasks + Idle + timer*/
...
#define configKERNEL_INTERRUPT_PRIORITY           ( 255 ) /*configKERNEL_INTERRUPT_PRIORITY should be set to the lowest priority. http://www.freertos.org/a00110.html#kernel_priority*/
