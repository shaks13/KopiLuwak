...
static void StartTransferDMALoop( SPIDRV_Handle_t handle,
                              const void *txBuffer,
                              void *rxBuffer,
                              int count,
                              uint16_t ui16nbloop,
 ...
 *    SPIDRV @ref Ecode_t is returned.
 ******************************************************************************/
Ecode_t SPIDRV_MTransferBloop( SPIDRV_Handle_t handle,
                           const void *txBuffer,
                           void *rxBuffer,
                           int count,
                           uint16_t ui16nbloop)
{
  Ecode_t retVal;
  /* update the TxDMA signal*/
  handle->txDMASignal = dmadrvPeripheralSignal_PRS_REQ0; /* update the tx dma signam to prs*/
  ...
  StartTransferDMALoop( handle, txBuffer, rxBuffer, count,  ui16nbloop,BlockingComplete );
                              ...
                              SPIDRV_Callback_t callback )
{
  ...
  // Start transmit dma.
  DMADRV_MemoryPeripheralLoop( handle->txDMACh,
                           handle->txDMASignal,
                           txPort,
                           (void*)txBuffer,
                           true,
