...
/** Set the NVM buffers size in word. */
#define NVM_SIZE_SAMPLE_BUFFER_IN_WORD               (1000)
...
typedef enum
{
  NVM_TABLE_ID_TEMPERATURE = 0,
  NVM_TABLE_ID_NB_TEMPERATURE,
  NVM_TABLE_ID_ACCELERO,
  NVM_TABLE_ID_NB_ACCELERO,
  NVM_TABLE_ID_MAGNETO,
  NVM_TABLE_ID_NB_MAGNETO,
  NVM_TABLE_ID_LAST
} NVM_Object_Ids;
...
extern uint16_t nvm_ui16TempBuffer[NVM_SIZE_SAMPLE_BUFFER_IN_WORD]; /* #define DATAACQ_MEASBUFFER_NBELEMENT in measurement service  */
extern uint16_t nvm_ui16AcceleroBuffer[NVM_SIZE_SAMPLE_BUFFER_IN_WORD];
extern uint16_t nvm_ui16MagnetoBuffer[NVM_SIZE_SAMPLE_BUFFER_IN_WORD];
/* Flash variables containing the number of samples per sensors already stored in RAM */
extern uint16_t nvm_ui16NbTempSamples;
extern uint16_t nvm_ui16NbAcceleroSamples;
extern uint16_t nvm_ui16NbMagnetoSamples;
/*******************************************************************************
 *****************************   PROTOTYPES   **********************************
 ******************************************************************************/
