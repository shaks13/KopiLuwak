...
/// default descriptor address values ( driver overload)
#define DMADRV_DEFAULT_DESCRIPTOR_ADRS_VALUE (0)
/* length of the buffer where the samples are stored ( driver overload)*/
#define DMADRV_LENGTH_DST_BUFFER (5)
/* 1 sample = 4 * 8 bit = 32 bit ( driver overload)*/
#define DMADRV_SIZE_SAMPLE_IN_OCTET (4)
...
/// ( driver overload)
void DMADRV_SetUpChannelForPRS(uint8_t ui8Chl,  uint32_t * ui32AdrsSRC, uint32_t * ui32AdrsDST);
