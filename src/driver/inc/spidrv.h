...
/// Configuration data for SPI master using USART1.
#define SPIDRV_MASTER_USART1_FOREM4325									  \
{                                                                         \
  USART1,                      /* USART port                       */    \
  _USART_ROUTELOC0_TXLOC_LOC0, /* USART Tx pin location number     */    \
  _USART_ROUTELOC0_RXLOC_LOC0, /* USART Rx pin location number     */    \
...
/// Configuration data for SPI master using USART1.
#define SPIDRV_MASTER_USART0_FORLIS2DH								  \
{                                                                         \
  USART0,                       /* USART port                       */    \
  _USART_ROUTELOC0_TXLOC_LOC0,  /* USART Tx pin location number     */    \
  _USART_ROUTELOC0_RXLOC_LOC0,  /* USART Rx pin location number     */    \
...
/// Configuration data for SPI master using USART1.
#define SPIDRV_MASTER_USART0_FORLIS2DH_ONEVALBOARD								  \
{                                                                         \
  USART0,                       /* USART port                       */    \
...
/// Configuration data for SPI master using USART1.
#define SPIDRV_MASTER_USART1_FOREXTMEMORY								  \
{                                                                         \
  USART1,                       /* USART port                       */    \
  _USART_ROUTELOC0_TXLOC_LOC0,  /* USART Tx pin location number     */    \
  _USART_ROUTELOC0_RXLOC_LOC0,  /* USART Rx pin location number     */    \
...
/// Configuration data for SPI master using USART0.
#define SPIDRV_MASTER_USART0_FORADXL363								  \
{                                                                         \
  USART0,                       /* USART port                       */    \
...
/// Configuration data for SPI master using USART1.
#define SPIDRV_MASTER_USART1_FORADXL363								  \
{                                                                         \
  USART1,                       /* USART port                       */    \
  _USART_ROUTELOC0_TXLOC_LOC11, /* USART Tx pin location number     */    \
  _USART_ROUTELOC0_RXLOC_LOC11, /* USART Rx pin location number     */    \
