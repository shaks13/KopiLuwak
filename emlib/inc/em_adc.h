...
#define ADC_INITSINGLE_MINE                                                    \
{                                                                                 \
  adcPRSSELCh0,              /* PRS ch0 (if enabled). */                          \
  adcAcqTime1,               /* 1 ADC_CLK cycle acquisition time. */              \
  adcRef2V5,                /* 1.25V internal reference. */                      \
  adcRes12Bit,               /* 12 bit resolution. */                             \
  adcPosSelAPORT3XCH4,         /* Select node BUS0XCH0 as posSel */                 \
  adcPosSelAPORT3XCH6,         /* Select node BUS0XCH1 as negSel */                 \
